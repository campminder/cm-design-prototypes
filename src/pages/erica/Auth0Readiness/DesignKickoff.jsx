...
import logoSrc from '../../../assets/cm-logo-horizontal-tagline-light.svg';

// Current experience screenshots — New Account flow
import current01 from '../../../assets/auth0/current-experience/01-camp-homepage.png';
import current02 from '../../../assets/auth0/current-experience/02-prompted-to-login.png';
import current03 from '../../../assets/auth0/current-experience/03-signup-prompt.png';
import current05 from '../../../assets/auth0/current-experience/05-verify-identity-screen.png';
import current06 from '../../../assets/auth0/current-experience/06-verify-identity-email.png';
import current07 from '../../../assets/auth0/current-experience/07-create-account.png';
import current08 from '../../../assets/auth0/current-experience/08-create-account-detail.png';
import current09 from '../../../assets/auth0/current-experience/09-login-after-creation.png';
import current10 from '../../../assets/auth0/current-experience/10-login-with-password.png';

// Current experience screenshots — Existing Account flow
import existing01 from '../../../assets/auth0/current-experience/existing-01-camp-homepage.png';
import existing02 from '../../../assets/auth0/current-experience/existing-02-prompted-to-login.png';
import existing03 from '../../../assets/auth0/current-experience/existing-03-try-create-account.png';
import existing04 from '../../../assets/auth0/current-experience/existing-04-creating-account.png';
import existing05 from '../../../assets/auth0/current-experience/existing-05-creating-account-2.png';
import existing06 from '../../../assets/auth0/current-experience/existing-06-surprise-have-account.png';
import existing07 from '../../../assets/auth0/current-experience/existing-07-password-autofill.png';
import existing08 from '../../../assets/auth0/current-experience/existing-08-logged-in.png';

// Current experience screenshots — Forgot Password flow
import forgot01 from '../../../assets/auth0/current-experience/forgot-01-enter-email.png';
import forgot02 from '../../../assets/auth0/current-experience/forgot-02-weird-email.png';
import forgot03 from '../../../assets/auth0/current-experience/forgot-03-verify-identity.png';
import forgot04 from '../../../assets/auth0/current-experience/forgot-04-reset-password.png';
import forgot05 from '../../../assets/auth0/current-experience/forgot-05-changed-now-what.png';

// New design screenshots — New Account flow
import newAcct01 from '../../../assets/auth0/new-design/new-account-step-01.png';
import newAcct02 from '../../../assets/auth0/new-design/new-account-step-02.png';
import newAcct03 from '../../../assets/auth0/new-design/new-account-step-03.png';
import newAcct04 from '../../../assets/auth0/new-design/new-account-step-04.png';
import newAcctEmail from '../../../assets/auth0/new-design/new-account-verify-email.png';
import newAcct05 from '../../../assets/auth0/new-design/new-account-step-05.png';
import newAcct06 from '../../../assets/auth0/new-design/new-account-step-06.png';

// New design screenshots — Returning Login flow
import returning02 from '../../../assets/auth0/new-design/returning-step-02.png';
import returning03 from '../../../assets/auth0/new-design/returning-step-03.png';
import returning04 from '../../../assets/auth0/new-design/returning-step-04.png';
import returning05 from '../../../assets/auth0/new-design/returning-step-05.png';

// New design screenshots — Forgot Password flow
import forgotNew02 from '../../../assets/auth0/new-design/forgot-password-step-02.png';
import forgotNew03 from '../../../assets/auth0/new-design/forgot-password-step-03.png';
import forgotNew04 from '../../../assets/auth0/new-design/forgot-password-step-04.png';
import forgotNew05 from '../../../assets/auth0/new-design/forgot-password-step-05.png';
import forgotNew06 from '../../../assets/auth0/new-design/forgot-password-step-06.png';
import forgotNew07 from '../../../assets/auth0/new-design/forgot-password-step-07.png';
import forgotNew08 from '../../../assets/auth0/new-design/forgot-password-step-08.png';
import forgotNew09 from '../../../assets/auth0/new-design/forgot-password-step-09.png';

// New design screenshots — Claim Account flow
import claimWelcome from '../../../assets/auth0/new-design/claim-account-welcome-email.png';
import claim02 from '../../../assets/auth0/new-design/claim-account-step-02.png';
import claim03 from '../../../assets/auth0/new-design/claim-account-step-03.png';
import claim04 from '../../../assets/auth0/new-design/claim-account-step-04.png';
import claimEmail from '../../../assets/auth0/new-design/claim-account-verify-email.png';
import claim05 from '../../../assets/auth0/new-design/claim-account-step-05.png';
import claim06 from '../../../assets/auth0/new-design/claim-account-step-06.png';
      ...
      <div className="cm-kickoff__controls">
        ...
        {activeView === 'proposed' && (
          <button
            ...
            type="button"
          >
            {showScope ? <Eye size={16} /> : <EyeOff size={16} />}
          ...
          <div key={flow.id} className="cm-kickoff__flow">
            <div className="cm-kickoff__flow-header">
              ...
              <button
                ...
                type="button"
              >
                Try prototype <ExternalLink size={14} />
              </button>
            </div>
