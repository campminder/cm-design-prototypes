 ...
 */
export const CAMP_TALL_PINES = {
  name: 'Camp Tall Pines',
  accentColor: '#2d6a4f',
  initials: 'TP',
  logoUrl: campTallPinesLogo,
  backgroundUrl: campHero,
};

export const CAMP_SUNSHINE = {
  name: 'Camp Sunshine',
  accentColor: '#e07c24',
  initials: 'CS',
};

export const CAMP_BLUE_RIDGE = {
...
export const CAMPMINDER_DEFAULT = {
  name: 'campminder',
  accentColor: '#773DBD',
  initials: 'CM',
  logoUrl: undefined,
