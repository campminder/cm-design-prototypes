...
const STEPS = ['camp-website', 'email-entry', 'password', 'password-error', 'request', 'check-email', 'new-password', 'success', 'home'];
      ...
      {step === 'new-password' && (
        <>
          ...
          <div className="cm-auth-migration-banner">
            <InfoOutlinedIcon className="cm-auth-migration-banner__icon" size={16} />
            <span>
