...
const STEPS = ['caregiver-dashboard', 'guest-accounts-page', 'guest-email', 'create-account', 'loading', 'guest-home'];

export const GuestAccountFlow = () => {
  const { navigate, search } = useNav();
  const searchParams = new URLSearchParams(search);
  const brand = searchParams.get('brand') === 'default' ? CAMPMINDER_DEFAULT : CAMP;
  const [step, setStep] = useState('caregiver-dashboard');
