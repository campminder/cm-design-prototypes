...
import { Signal as SignalCellular4BarIcon } from 'lucide-react';
import { Wifi as WifiIcon } from 'lucide-react';
import { Battery as BatteryFullIcon } from 'lucide-react';
import { Menu as MenuIcon } from 'lucide-react';
import { Ticket as LocalActivityIcon } from 'lucide-react';
import { LayoutList as ViewStreamIcon } from 'lucide-react';
import { Image as PhotoLibraryIcon } from 'lucide-react';
...
const STEPS = ['app-onboarding', 'campanion-login', 'password', 'home'];

export const CampanionFlow = () => {
  const { navigate } = useNav();
  const [step, setStep] = useState('app-onboarding');
      ...
      <div className="cm-campanion__phone">
        <div className={clsx('cm-campanion__status-bar', step === 'home' && 'cm-campanion__status-bar--light')}>
          ...
          <span className="cm-campanion__status-bar-icons">
            <SignalCellular4BarIcon size={14} />
            <WifiIcon size={14} />
          ...
          <div className="cm-campanion__sheet">
            ...
            <div className="cm-campanion__sheet-body">
              ...
              <div className="cm-campanion__sheet-branding">
                <div style={{ fontSize: 24, fontWeight: 700, color: '#e07c24', padding: '8px 0' }}>Campanion</div>
              </div>
          ...
          <div className="cm-campanion__stream">
            ...
            <div className="cm-campanion__stream-feed">
              ...
              <div className="cm-campanion__stream-card">
                <div className="cm-campanion__stream-card-hero" style={{ background: '#2d6a4f' }}>
              ...
              {/* Card 2: Tagged photo */}
              <div className="cm-campanion__stream-card">
                <div className="cm-campanion__stream-card-hero" style={{ background: '#457b9d', minHeight: 160 }}>
                  <div className="cm-campanion__stream-card-overlay" />
                </div>
                <div className="cm-campanion__stream-card-info">
                ...
                <div className="cm-campanion__sidenav">
                  ...
                  <nav className="cm-campanion__sidenav-links">
                    <button className="cm-campanion__sidenav-item">
                      <ViewStreamIcon size={22} />
                      <span>Stream</span>
                    </button>
                    <button className="cm-campanion__sidenav-item">
                      <PhotoLibraryIcon size={22} />
                      <span>Photos</span>
                    </button>
                    <button className="cm-campanion__sidenav-item">
                      <StarIcon size={22} />
                  ...
                  <div className="cm-campanion__sidenav-footer">
                    <div className="cm-campanion__sidenav-footer-row">
                      ...
                      <SettingsIcon size={20} style={{ color: '#999' }} />
                    </div>
                  </div>
                </div>
              </>
        ...
        {step === 'app-onboarding' && (
          <>
            <div className="cm-auth-info-banner">
              <InfoOutlinedIcon style={{ flexShrink: 0, marginTop: 2 }} size={16} />
              <span>
