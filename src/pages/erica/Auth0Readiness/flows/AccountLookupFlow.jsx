...
export const AccountLookupFlow = () => {
        ...
        <div className="cm-lookup__result">
          <div className="cm-lookup__result-header">
            {result.status === 'verified' && (
              <CheckCircleOutlineIcon className="cm-lookup__icon cm-lookup__icon--verified" size={28} />
            )}
            {result.status === 'unverified' && (
              <ErrorOutlineIcon className="cm-lookup__icon cm-lookup__icon--unverified" size={28} />
            )}
            {result.status === 'not-found' && (
              <HelpOutlineIcon className="cm-lookup__icon cm-lookup__icon--not-found" size={28} />
            )}
            <div>
