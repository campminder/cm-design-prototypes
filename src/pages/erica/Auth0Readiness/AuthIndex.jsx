...
import { KeyRound as LockResetIcon } from 'lucide-react';
import { UserCog as SupervisorAccountIcon } from 'lucide-react';
import { Mail as EmailIcon } from 'lucide-react';
import { Smartphone as PhoneIphoneIcon } from 'lucide-react';
import { SearchCode as ManageSearchIcon } from 'lucide-react';
import { Unlink as LinkOffIcon } from 'lucide-react';
import { UserPlus as PersonAddAlt1Icon } from 'lucide-react';
import { UserPlus as GroupAddIcon } from 'lucide-react';
import { Home as AddHomeIcon } from 'lucide-react';
import { CreditCard as BadgeIcon } from 'lucide-react';
import { ArrowUpCircle as UpgradeIcon } from 'lucide-react';
...
const journeys = [
  ...
  },
  {
    ...
    route: '/auth/guest',
    icon: <SupervisorAccountIcon size={20} />,
  ...
  },
  {
    ...
    icon: <PersonAddAlt1Icon size={20} />,
    tags: ['Edge Case', 'Account Linking'],
  },
];

const guestEdgeCases = [
  {
    id: 7,
...
export const AuthIndex = () => {
  ...
  const [brand, setBrand] = useState('camp');
    ...
    <div className="cm-auth-index">
      <div className="cm-auth-index__container">
        <div className="cm-auth-index__header">
          <div className="cm-auth-index__logo-text">CampMinder</div>
